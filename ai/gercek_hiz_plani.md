...
- **Odak (`focal_px`):** Kalibre kamera yoksa yatay FOV varsayımından (`f=(W/2)/tan(HFOV/2)`, HFOV≈55°). Daha iyisi Yöntem C (VP) odağı bağlanınca mutlak ölçek de iyileşir.
...
Aşama 0–3 tek başına kullanılabilir metrik hız verir ve gizli test setinde çalışır; 4–6 sağlamlık ve kanıt katmanıdır. **Aşama 2+ (PnP, 2026-06-07 uygulandı)** Yöntem A'yı açılı plakalara genişletir — durum/ölçüm `gercek_hiz_progress.md`'de.
