...
| `/api/events` | GET | Riskli olay listesi — from_ts/to_ts/level/vtype/min_score filtreli |
| `/api/events/{id}` | GET | Tek olay detayı |
| `/api/events/export` | GET | Tüm olayları CSV indir |
...
| Mock modda uçtan uca çalışma | ✅ 121 test yeşil |
...
| **Zengin API: statistics, vehicles/{plate}, events/{id}, export** | ✅ Tamamlandı |
| **CAMARA env vars (mock→real geçiş altyapısı)** | ✅ Tamamlandı |
